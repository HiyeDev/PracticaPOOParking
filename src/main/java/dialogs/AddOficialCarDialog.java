...
public class AddOficialCarDialog extends JDialog{
    private JTextField licensePlateField;
    
    public AddOficialCarDialog(Frame parent) {
        super(parent, "Add Oficial Car", true);
        ...
        addButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                OficialCarDAO.registerOficialCar(new OficialCar(licensePlateField.getText()));
                dispose();
            }
